...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "ณัฐวดี ค้ำชู เป็นนักศึกษา AAI มหาวิทยาลัยบูรพา",
        "ณัฐวดี ค้ำชู มีชื่อเล่นว่า บิว เกิดวันที่ 16 มีนาคม 2547 ที่จังหวัดฉะเชิงเทรา ศึกษาอยู่ที่มหาวิทยาลัยบูรพา",
        ...
        "ClickNext team AI มี พี่เจ๋ง ทำน้าที่เป็น Dev, พี่ดาว ทำหน้าที่เป็น BA, พี่ออย ทำหน้าที่เป็น BA, พี่ปาล์ม ทำหน้าที่ Backend, และ พี่ชวน ทำหน้าที่ Dataops"
    ]
